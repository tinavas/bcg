...
require_once 'class.connection_mssql.php';

class Connection extends I3_Connection
      {
        ...
        * This method opens the database connection (only call if closed!) */
         ...
         * This method closes the connection to the MySQL Database */
         ...
         public function vici_db() {
         	$this->NewConnection('191.168.3.235', 'asterisk', 'cron', '1234');
         }
         
         public function local_db() {
         	$this->NewConnection('localhost', 'bcg', 'root', '');
         }
